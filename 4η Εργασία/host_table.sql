--Optionally Step: Make a copy of table "Listings" 
--CREATE TABLE "ListingsCopy" AS TABLE "Listings";

--1st Step : Creation of "Host" table
--2nd Step : Remove the "host_" from the fields 
...
--3rd Step : Add a primary key to "Host" table 
  ALTER TABLE "Host" 
  ADD PRIMARY KEY (id);

--4rth Step : Add a foreign key to "Listings" table 
  ALTER TABLE "Listings"
  ADD FOREIGN  KEY (host_id) REFERENCES "Host"(id);

--5th Step : Delete the fields from "Listings" we don't need 
  ALTER TABLE "Listings" 
